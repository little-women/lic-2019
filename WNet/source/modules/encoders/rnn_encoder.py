...
class RNNEncoder(nn.Module):
    ...
    inputs: Tensor(batch_size, query_length, query_size)
    outputs: Tensor(batch_size, seq_length, hidden_size*num_directions)
    last_hidden: Tensor((num_layers, batch_size, num_directions * hidden_size))
    """
    def __init__(self,
                 input_size,
                 hidden_size,
